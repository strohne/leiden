...
"""tst_dio_grammar.py - runs the unit tests for the dio-grammar
"""
...
if __name__ == '__main__':
    ...
    read_local_config(os.path.join(scriptdir, 'dioConfig.ini'))
    ...
    if args.scripts:
        dsl.create_scripts(os.path.join(scriptdir, 'dio.ebnf'))
    ...
    if arg.endswith('.ebnf'):
        ...
        recompile_grammar(os.path.join(scriptdir, 'dio.ebnf'),
                          force=False)
        sys.path.append('.')
        from dioParser import parsing, ASTTransformation, \
